      ...
      <>
        <DivModalMovieInformations>
          <DivScreenMovie>
            ...
            <DivPlay>
              <iframe
                src={`${video}?enablejsapi=1&autoplay=1&mute=0&rel=0&modestbranding=0&autohide=1&controls=1`}
          ...
          <DivInformationsMovie>
            ...
            <DivFuncionalities>
              ...
              <button>
                <BsPlusCircle color="#FFC124" size={20} />
              </button>
              <button
                onClick={() => {
              ...
              >
                <BsChatLeft color="#FFC124" size={20} />
              </button>
              <ButtonSeeReviews onClick={() => navigate("/community")}>
                Ver Reviews
              </ButtonSeeReviews>
            </DivFuncionalities>
          </DivInformationsMovie>
